rule Trojan_Win32_SuspSchtask_C_2147782852_0
{
    ...
    strings:
        $x_10_1 = {63 00 6d 00 64 00 2e 00 65 00 78 00 65 00 20 00 2f 00 63 00 20 00 73 00 63 00 68 00 74 00 61 00 73 00 6b 00 73 00 2e 00 65 00 78 00 65 00 90 00 00 00}  //weight: 10, accuracy: High
