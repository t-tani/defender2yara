...
rule Trojan_Win32_AutoitInject_HNQ_2147932010_0
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = "PROCESSEXISTS ( \"robocopy.exe\" )" ascii //weight: 2
        $x_1_2 = {57 00 49 00 4e 00 57 00 41 00 49 00 54 00 41 00 43 00 54 00 49 00 56 00 45 00 20 00 28 00 20 00 22 00 [0-64] 45 00 64 00 69 00 74 00 6f 00 72 00 22 00 20 00 2c 00 20 00 [0-64] 20 00 2c 00 20 00 [0-16] 20 00 29 00}  //weight: 1, accuracy: Low
        $x_1_3 = {57 49 4e 57 41 49 54 41 43 54 49 56 45 20 28 20 22 [0-64] 45 64 69 74 6f 72 22 20 2c 20 [0-64] 20 2c 20 [0-16] 20 29}  //weight: 1, accuracy: Low
        $x_1_4 = {57 00 49 00 4e 00 57 00 41 00 49 00 54 00 41 00 43 00 54 00 49 00 56 00 45 00 20 00 28 00 20 00 22 00 [0-64] 4d 00 61 00 69 00 6c 00 22 00 20 00 2c 00 20 00 [0-64] 20 00 2c 00 20 00 [0-16] 20 00 29 00}  //weight: 1, accuracy: Low
        $x_1_5 = {57 49 4e 57 41 49 54 41 43 54 49 56 45 20 28 20 22 [0-64] 4d 61 69 6c 22 20 2c 20 [0-64] 20 2c 20 [0-16] 20 29}  //weight: 1, accuracy: Low
        $x_1_6 = {57 00 49 00 4e 00 53 00 45 00 54 00 4f 00 4e 00 54 00 4f 00 50 00 20 00 28 00 20 00 22 00 [0-64] 45 00 64 00 69 00 74 00 6f 00 72 00 22 00 20 00 2c 00 20 00 [0-64] 20 00 2c 00 20 00 [0-16] 20 00 29 00}  //weight: 1, accuracy: Low
        $x_1_7 = {57 49 4e 53 45 54 4f 4e 54 4f 50 20 28 20 22 [0-64] 45 64 69 74 6f 72 22 20 2c 20 [0-64] 20 2c 20 [0-16] 20 29}  //weight: 1, accuracy: Low
        $x_10_8 = {50 00 49 00 4e 00 47 00 20 00 28 00 20 00 22 00 68 00 74 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 [0-64] 2e 00 [0-16] 22 00 20 00 2c 00 20 00 [0-16] 20 00 2c 00 20 00 [0-16] 20 00 29 00}  //weight: 10, accuracy: Low
        $x_10_9 = {50 49 4e 47 20 28 20 22 68 74 74 74 70 3a 2f 2f [0-64] 2e [0-16] 22 20 2c 20 [0-16] 20 2c 20 [0-16] 20 29}  //weight: 10, accuracy: Low
        $x_10_10 = {50 00 52 00 4f 00 43 00 45 00 53 00 53 00 43 00 4c 00 4f 00 53 00 45 00 20 00 28 00 20 00 22 00 [0-64] 2e 00 65 00 78 00 65 00 22 00 20 00 29 00}  //weight: 10, accuracy: Low
        $x_10_11 = {50 52 4f 43 45 53 53 43 4c 4f 53 45 20 28 20 22 [0-64] 2e 65 78 65 22 20 29}  //weight: 10, accuracy: Low
        $x_10_12 = {50 00 52 00 4f 00 43 00 45 00 53 00 53 00 57 00 41 00 49 00 54 00 20 00 28 00 20 00 22 00 [0-64] 2e 00 65 00 78 00 65 00 22 00 20 00 2c 00 20 00}  //weight: 10, accuracy: Low
        $x_10_13 = {50 52 4f 43 45 53 53 57 41 49 54 20 28 20 22 [0-64] 2e 65 78 65 22 20 2c 20}  //weight: 10, accuracy: Low
        $x_10_14 = "GUICTRLSETDATA (" ascii //weight: 10
    condition:
        (filesize < 20MB) and
        (
