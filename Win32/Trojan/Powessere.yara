...
rule Trojan_Win32_Powessere_G_2147725444_2
{
    ...
    strings:
        ...
        $x_1_3 = {20 00 6a 00 61 00 76 00 61 00 73 00 63 00 72 00 69 00 70 00 74 00 3a 00 [0-4] 5c 00 2e 00 2e 00 5c 00}  //weight: 1, accuracy: Low
        $x_1_4 = {20 00 76 00 62 00 73 00 63 00 72 00 69 00 70 00 74 00 3a 00 [0-4] 5c 00 2e 00 2e 00 5c 00}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (
            ((2 of ($x_2_*) and 1 of ($x_1_*))) or
