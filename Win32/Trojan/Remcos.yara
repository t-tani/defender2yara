...
rule Trojan_Win32_Remcos_BSA_2147932044_0
{
    ...
    strings:
        ...
        $x_4_2 = {66 ee 94 0f 66 ea 62 0f 66 74 9b 0c 66 f6 09 0f 66 87 9b 0c 66 93 95 0f 66 85 9a 0c 66 df 47 0e}  //weight: 4, accuracy: High
        $x_4_3 = {66 89 06 0f 66 ba 03 0f 66 13 75 10 66 2b 94 0f 66 37 a2 0d 66 3a 03 0f 66 3a 04 0f 66 6e 03 0f}  //weight: 4, accuracy: High
        $x_2_4 = {ff ff ff c1 ff ff fc 3c 7f ff c3 fc 1f f8 3f fc 07 fb ff fc 1f fb ff fc 7f fb ff fd ff fb ff fd}  //weight: 2, accuracy: High
        $x_2_5 = {ff fb ff fd ff fb ff fd ff fb ff fd ff fb ff fd ff fb ff fd ff fb ff fd ff fb ff c1 ff fb fc 3d}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
