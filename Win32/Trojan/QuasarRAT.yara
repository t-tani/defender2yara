...
rule Trojan_Win32_QuasarRAT_GV_2147977785_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/QuasarRAT.GV!MTB"
        threat_id = "2147977785"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "QuasarRAT"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "main.getAESKey" ascii //weight: 1
        $x_1_2 = "main.getPayloadToken" ascii //weight: 1
        $x_1_3 = "main.decryptPayload" ascii //weight: 1
        $x_1_4 = "main.antiSandbox" ascii //weight: 1
        $x_1_5 = "main.download" ascii //weight: 1
        $x_1_6 = "main.download.deferwrap1" ascii //weight: 1
        $x_1_7 = "main.persist" ascii //weight: 1
        $x_1_8 = "main.hiddenAttr" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
