...
rule Trojan_MSIL_Heracles_SPQE_2147901392_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Heracles.SPQE!MTB"
        threat_id = "2147901392"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Heracles"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {07 02 08 6f ?? ?? ?? 0a 06 08 06 6f ?? ?? ?? 0a 5d 6f ?? ?? ?? 0a 61 d1 6f ?? ?? ?? 0a 26 00 08 17 58 0c}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Heracles_AMBF_2147917561_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Heracles.AMBF!MTB"
        threat_id = "2147917561"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Heracles"
        severity = "Critical"
