rule Trojan_Win64_Shaolaod_A_2147928136_0
{
    ...
    strings:
        $x_1_1 = {40 5e c0 84 c7 [0-6] 02 9f e6 6a c7 [0-6] f4 15 93 b0 c7}  //weight: 1, accuracy: Low
        $x_1_2 = {ff 1f 7c c9 c7 [0-6] 6c e1 eb 9f c7 [0-6] 35 f6 53 22 c7}  //weight: 1, accuracy: Low
